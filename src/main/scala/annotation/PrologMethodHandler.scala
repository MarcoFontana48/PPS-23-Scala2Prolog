...
import alice.tuprolog.{SolveInfo, Term, Prolog, Theory}
...
object PrologMethodHandler extends PrologMethodUtils with PrologAnnotationHandler with Logging:
  def executeAnnotation(method: Method, args: Array[AnyRef]): AnyRef =
    ...
    setTheoryAndSolveGoal(fields, Option(args), method)
   ...
   */
  private def setTheoryAndSolveGoal(fields: PrologMethodFields, args: Option[Array[AnyRef]], method: Method): Iterable[AnyRef] =
